...
class TraitsControllerTest < ActionController::TestCase
  ...
  test "should create trait" do
    assert_difference('Trait.count') do
      post :create, trait: { description: @trait.description, display: @trait.display, name: @trait.name, trait_type_id: @trait.trait_type_id }
    end
  ...
  test "should update trait" do
    patch :update, id: @trait, trait: { description: @trait.description, display: @trait.display, name: @trait.name, trait_type_id: @trait.trait_type_id }
    assert_redirected_to trait_path(assigns(:trait))
  end
